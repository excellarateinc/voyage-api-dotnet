...
AS (
	...
	FROM (
		VALUES 
			 ...
			 ,(2, 'Meeting Reminder for 2 PM. Meeting with potential client about a potential big deal.', 'fb9f65d2-699c-4f08-a2e4-8e6c28190a84', 0, 'fb9f65d2-699c-4f08-a2e4-8e6c28190a84', GETDATE())

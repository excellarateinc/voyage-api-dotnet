...
namespace Launchpad.UnitTests.Web.Controllers.API.V1
{
    ...
    public class RoleControllerTests : BaseUnitTest
    {
        ...
        {
            _roleController.AssertClaim(_ => _.GetClaims("id"), Constants.Claims.ListRoleClaims);
        }
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        {
            _roleController.AssertClaim(_ => _.RemoveClaim("a", 1), Constants.Claims.DeleteRoleClaim);
        }
        ...
        {
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            _roleController.AssertClaim(_ => _.RemoveRole("id"), Constants.Claims.DeleteRole);
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        }
        ...
        {
            _roleController.AssertClaim(_ => _.GetRoles(), Constants.Claims.ListRoles);
        }
        ...
        {
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            _roleController.AssertClaim(_ => _.CreateRole(new RoleModel()), Constants.Claims.CreateRole);
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        }
        ...
        {
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            _roleController.AssertClaim(_ => _.AddClaim("id", new ClaimModel()), Constants.Claims.CreateClaim);
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        }
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        {
            _roleController.AssertClaim(_ => _.GetRoleById("id"), Constants.Claims.ViewRole);
        }
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        {
            _roleController.AssertClaim(_ => _.GetClaimById("roleId", 0), Constants.Claims.ViewClaim);
        }
